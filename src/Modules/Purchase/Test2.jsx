  ...
  const handleDraft = async () => {
    try {
      ...
      const requests = updatedItems.map((item) => {
        ...
        console.log("hiiiii");
        console.log(formatDate(item.receivedDate));
        const data = new FormData();
        // data.append("title", indentForm.values.title);
        // data.append("description", indentForm.values.description);
        data.append("id", item.pid);
        data.append("vendor", item.vendor);
        data.append("current_stock", item.presentStock);
        data.append("bill", item.file);
        data.append("location", item.location);
        data.append("received_date", formatDate(item.receivedDate));
        data.append("role", role);
        // data.append("role", role);
        // Return the axios POST request promise
        console.log(data);
